...
class FrmViewsDisplaysController {
	...
	public static function add_meta_boxes( $post_type ) {
		...
		add_meta_box( 'frm_excerpt', __( 'Description' ), 'FrmViewsDisplaysController::mb_excerpt', self::$post_type, 'normal', 'high' );
	...
	private static function search_by_id( &$query ) {
		if ( 0 !== $query->found_posts || FrmAppHelper::is_admin() || ! is_search() ) {
			return;
		}
